...
namespace MT.Core.Lib
{
    ...
    /// 核心库日志
    /// </summary>
    public class CoreGUIManager : LogManagerBase
    {
        public readonly static CoreGUIManager Instance = new CoreGUIManager();
        public CoreGUIManager()
        {
            gameLog = log4net.LogManager.GetLogger("MT.Core.GUI");
        }
    }
    ...
    public class GameLogManager : LogManagerBase
    {
        ...
        public override void Debug(string log)
        {
            ...
            CoreGUIManager.Instance.Debug(log);
        ...
        public override void Error(string log)
        {
            ...
            CoreGUIManager.Instance.Error(log);
        ...
        public override void Fatal(string log)
        {
            ...
            CoreGUIManager.Instance.Fatal(log);
        ...
        public override void Info(string log)
        {
            ...
            CoreGUIManager.Instance.Info(log);
        ...
        public override void Warn(string log)
        {
            ...
            CoreGUIManager.Instance.Warn(log);
        ...
        public override void InfoWithCallback(string log)
        {
            ...
            CoreGUIManager.Instance.InfoWithCallback(log);
        ...
        public override void ErrorWithCallback(string log)
        {
            ...
            CoreGUIManager.Instance.ErrorWithCallback(log);
